...
const Onboarding10 = () => {
  return (
    <div className="font-sans bg-gray-100 min-h-screen w-[50%] flex flex-col items-center justify-center relative">
      {/* Background Content */}
      <div className="absolute inset-0 bg-gray-50 bg-opacity-50 flex items-center justify-center">
        ...
        <div className="bg-white rounded-lg shadow-lg w-[90%] max-w-md p-6">
          ...
          <p className='text-center mb-4'>"gmail.com" to Sign in</p>
