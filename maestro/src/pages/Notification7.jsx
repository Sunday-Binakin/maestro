...
const Notification7 = () => {
  return (
    <div className="bg-gray-100 h-screen w-[50%] flex flex-col">
      ...
      <div className="bg-white mx-4 mt-2 p-4 rounded-lg shadow-md relative">
        <div className="flex items-center mb-4">
          <img
            src="/path-to-maestro-logo.png"
            alt="Notification Icon"
      ...
      <div className="bg-yellow-500 text-center py-3 text-black font-semibold text-lg cursor-pointer mx-4">
        Request for Pickup
      </div>
    </div>
  );
